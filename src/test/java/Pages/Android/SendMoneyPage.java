...
public class SendMoneyPage {
    ...
    public static String otp_first_digit_field_send_money = "//android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup[1]";
    ...
    public static String first_bank_in_list = "(//android.view.ViewGroup[2]/android.view.ViewGroup)[2]";
    public static String send_money_button = "//android.widget.TextView[@text='Send Money']";

    public static String send_money_button2 = "(//android.widget.TextView[@text='Send Money'])[2]";
