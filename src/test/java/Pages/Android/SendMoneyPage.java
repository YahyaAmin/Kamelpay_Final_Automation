...
public class SendMoneyPage {
    ...
    public static String agree_terms_box = "//android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup[1]";
